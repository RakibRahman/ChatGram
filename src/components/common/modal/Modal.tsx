...
export const Modal: FC<ModalProps> = ({
    ...
    return ReactDOM.createPortal(
        ...
        >
            <div className="fixed bg-base-200 rounded-lg flex flex-col    max-h-[80vh] -translate-y-2/4 -translate-x-2/4 left-2/4 top-2/4 z-50 py-1 sm:py-2 sm:px-4 px-1 overflow-y-scroll overflow-hidden">
